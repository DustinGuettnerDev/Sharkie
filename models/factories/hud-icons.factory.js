...
function createHudIcons(world, character) {
    return [
        createLifeHudIcon(world, character),
...
/**
 * Creates the life HUD icon with the current life counter.
 * @param {World} world Current game world.
 * @param {Character} character Player character.
 * @returns {HudIcon} Life HUD icon.
 */
function createLifeHudIcon(world, character) {
    return new HudIcon({
...
/**
 * Creates the poison HUD icon with bottle count and specific icon sizing.
 * @param {World} world Current game world.
 * @param {Character} character Player character.
 * @returns {HudIcon} Poison HUD icon.
 */
...
/**
 * Creates the coin HUD icon with the current coin counter.
 * @param {World} world Current game world.
 * @param {Character} character Player character.
 * @returns {HudIcon} Coin HUD icon.
 */
